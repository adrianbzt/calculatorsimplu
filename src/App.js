    ...
    return (
      <div>
        ...
        <InputFields
          ...
          cost={Math.round(this.state.cost * 1 * 100) / 100}
          costMonth={Math.round(this.state.cost_month * 1 * 100) / 100}
          costYear={Math.round(this.state.cost_year * 1 * 100) / 100}
          costHourly={this.handleCostChange.bind(this, 1, parseFloat(1))}
          costMonthly={this.handleCostChange.bind(this, 1 / monthFormula, parseFloat(1))}
          costYearly={this.handleCostChange.bind(this, 1 / yearFormula, parseFloat(1))}
        />
